    ...
    private fun observeData() {
        ...
        viewModel.isUserComplete
            ...
            .onEach { isComplete ->
                ...
                if (!isComplete) {
                    ...
                    binding.txtDebugReason.text =
                        "Reason: User profile is incomplete (Age, Weight, Height, and Activity are required)."
                } else {
        ...
        viewModel.hasInterruptedSync
            ...
            .onEach { hasInterrupted ->
                binding.cardResumePrompt.visibility =
                    if (hasInterrupted) View.VISIBLE else View.GONE
            }
            .launchIn(viewLifecycleOwner.lifecycleScope)
